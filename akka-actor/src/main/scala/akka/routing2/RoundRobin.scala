...
/**
 * Uses round-robin to select a connection. For concurrent calls,
...
/**
 * A router pool that uses round-robin to select a connection. For concurrent calls,
 * round robin is just a best effort.
 *
...
/**
 * A router nozzle that uses round-robin to select a connection. For concurrent calls,
 * round robin is just a best effort.
 *
 * The configuration parameter trumps the constructor arguments. This means that
